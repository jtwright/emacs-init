...
(defface web-mode-html-tag-face
  '((((class color) (min-colors 88) (background dark))  :foreground "#e9c062")
    (((class color) (min-colors 88) (background light)) :foreground "#e9c062")
    (((class color) (min-colors 16) (background dark))  :foreground "#e9c062")
    (((class color) (min-colors 16) (background light)) :foreground "#e9c062")
    (((class color) (min-colors 8))                     :foreground "#e9c062")
...
(defface web-mode-html-tag-bracket-face
  '((((class color) (min-colors 88) (background dark))  :foreground "Snow3")
    (((class color) (min-colors 88) (background light)) :foreground "Snow3")
    (((class color) (min-colors 16) (background dark))  :foreground "Snow3")
    (((class color) (min-colors 16) (background light)) :foreground "Snow3")
...
(defface web-mode-html-attr-name-face
  '((((class color) (min-colors 88) (background dark))  :foreground "#3387cc")
    (((class color) (min-colors 88) (background light)) :foreground "#3387cc")
    (((class color) (min-colors 16) (background dark))  :foreground "#3387cc")
    (((class color) (min-colors 16) (background light)) :foreground "#3387cc")
    (((class color) (min-colors 8))                     :foreground "#3387cc")
    (((type tty) (class mono))                          :inverse-video t)
    (t                                                  :foreground "#3387cc"))
